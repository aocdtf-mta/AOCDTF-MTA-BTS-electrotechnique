...
pattern radius = 1pt}
\makeatletter
\pgfutil@ifundefined{pgf@pattern@name@_xiwsyuvea}{
\pgfdeclarepatternformonly[\mcThickness,\mcSize]{_xiwsyuvea}
{\pgfqpoint{0pt}{0pt}}
...
\draw  [draw opacity=0][pattern=_xiwsyuvea,pattern size=6pt,pattern thickness=0.75pt,pattern radius=0pt, pattern color={rgb, 255:red, 0; green, 0; blue, 0}][line width=0.75]  (17.5,232.5) -- (460,232.5) -- (460,247.5) -- (17.5,247.5) -- cycle ;
...
\draw [color={rgb, 255:red, 0; green, 0; blue, 0 }  ,draw opacity=1 ]   (337.5,112.5) -- (337.5,37.5) ;
%Straight Lines [id:da6729713455707143] 
