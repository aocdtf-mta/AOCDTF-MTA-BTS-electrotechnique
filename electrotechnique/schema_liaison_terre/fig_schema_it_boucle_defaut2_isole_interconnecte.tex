...
\draw [color={rgb, 255:red, 208; green, 2; blue, 27 }  ,draw opacity=1 ]   (232.5,102.5) -- (232.5,124.5) ;
\draw [shift={(232.5,127.5)}, rotate = 270] [fill={rgb, 255:red, 208; green, 2; blue, 27 }  ,fill opacity=1 ][line width=0.08]  [draw opacity=0] (5.36,-2.57) -- (0,0) -- (5.36,2.57) -- cycle    ;
%Straight Lines [id:da9290035127505091] 
\draw [color={rgb, 255:red, 208; green, 2; blue, 27 }  ,draw opacity=1 ]   (317.5,105.5) -- (317.5,127.5) ;
\draw [shift={(317.5,102.5)}, rotate = 90] [fill={rgb, 255:red, 208; green, 2; blue, 27 }  ,fill opacity=1 ][line width=0.08]  [draw opacity=0] (5.36,-2.57) -- (0,0) -- (5.36,2.57) -- cycle    ;
...
%Shape: Circle [id:dp04339447788790174] 
\draw  [fill={rgb, 255:red, 255; green, 255; blue, 255 }  ,fill opacity=1 ] (335,112.5) .. controls (335,111.12) and (336.12,110) .. (337.5,110) .. controls (338.88,110) and (340,111.12) .. (340,112.5) .. controls (340,113.88) and (338.88,115) .. (337.5,115) .. controls (336.12,115) and (335,113.88) .. (335,112.5) -- cycle ;
%Shape: Circle [id:dp9675506410006884] 
\draw  [fill={rgb, 255:red, 255; green, 255; blue, 255 }  ,fill opacity=1 ] (250,112.5) .. controls (250,111.12) and (251.12,110) .. (252.5,110) .. controls (253.88,110) and (255,111.12) .. (255,112.5) .. controls (255,113.88) and (253.88,115) .. (252.5,115) .. controls (251.12,115) and (250,113.88) .. (250,112.5) -- cycle ;
...
\draw  [dash pattern={on 4.5pt off 4.5pt}]  (250,112.5) -- (242.5,112.5) -- (242.5,130) ;
%Straight Lines [id:da9527130819146642] 
\draw  [dash pattern={on 4.5pt off 4.5pt}]  (335,112.5) -- (327.5,112.5) -- (327.5,130) ;
