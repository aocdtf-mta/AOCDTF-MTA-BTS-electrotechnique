...
pattern radius = 1pt}
\makeatletter
\pgfutil@ifundefined{pgf@pattern@name@_q9hh8w8s3}{
\pgfdeclarepatternformonly[\mcThickness,\mcSize]{_q9hh8w8s3}
{\pgfqpoint{0pt}{0pt}}
...
\draw  [draw opacity=0][pattern=_q9hh8w8s3,pattern size=6pt,pattern thickness=0.75pt,pattern radius=0pt, pattern color={rgb, 255:red, 0; green, 0; blue, 0}][line width=0.75]  (45,172.5) -- (460,172.5) -- (460,187.5) -- (45,187.5) -- cycle ;
