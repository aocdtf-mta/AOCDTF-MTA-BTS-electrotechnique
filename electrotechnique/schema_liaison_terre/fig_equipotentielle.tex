...
% Text Node
\draw (41.5,259.5) node  [font=\tiny] [align=left] {\cstep\label{pas:30}};
% Text Node
\draw (33.5,160.5) node  [font=\tiny] [align=left] {\cstep\label{pas:31}};
% Text Node
\draw (133.5,44.5) node  [font=\tiny] [align=left] {\cstep\label{pas:32}};
% Text Node
\draw (481.5,60.5) node  [font=\tiny] [align=left] {\cstep\label{pas:33}};
% Text Node
\draw (438.5,274.5) node  [font=\tiny] [align=left] {\cstep\label{pas:34}};
% Text Node
\draw (406.5,319.5) node  [font=\tiny] [align=left] {\cstep\label{pas:35}};
% Text Node
\draw (234.5,394.5) node  [font=\tiny] [align=left] {\cstep\label{pas:36}};
% Text Node
\draw (304.5,387.5) node  [font=\tiny] [align=left] {\cstep\label{pas:37}};
% Text Node
\draw (134.5,425.5) node  [font=\tiny] [align=left] {\cstep\label{pas:38}};
% Text Node
\draw (408.5,375.5) node  [font=\tiny] [align=left] {\cstep\label{pas:39}};
