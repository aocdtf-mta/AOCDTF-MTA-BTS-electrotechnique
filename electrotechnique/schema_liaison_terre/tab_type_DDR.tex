...
\toprule
	& \thead{Symbole}		& \thead{Caractéristiques}	& \thead{Forme d'onde}		& \thead{Type de charge} \\
\midrule
...
\multicolumn{5}{l}{\textit{Type AC}}	 \\
\middashrule
& \adjustbox{valign=t}{\includegraphics[height=0.4cm]{type_ac.png}}		& 
\begin{tabitemize}
...
\end{tikzpicture}}
  ...
  \\
\addlinespace
\multicolumn{5}{l}{\textit{Type A}}		\\
\middashrule
  	& \adjustbox{valign=t}{\includegraphics[height=0.4cm]{type_a.png}}		& 
\begin{tabitemize}
...
\end{tikzpicture}
  ...
  \\
\addlinespace
\multicolumn{5}{l}{\textit{Type F}}		\\*
\middashrule
  & \adjustbox{valign=t}{\includegraphics[height=0.4cm]{type_f.png}}		& 
\begin{tabitemize}
...
\end{tikzpicture}
  ...
  \\
\addlinespace
\multicolumn{5}{l}{\textit{Type B}}		\\*
\middashrule
	& \adjustbox{valign=t}{\includegraphics[height=0.4cm]{type_b.png}}		& 
\begin{tabitemize}
